...
<head>
    <title>Course Adviser Account Creation</title>
...
<center>
  ...
  <a href="#" data-toggle="modal" data-target="#myModal"><span class="label label-info lab"><b>Login</b></span></a>
</div>
    <h2><b>Create A Course Adviser Account</b></h2><br>
    </center>
<div class="container">
  <div class="row">
...
echo"<script>alert('An error occured,please try again..')</script>";    
  ...
  <div class=" form">
    ...
    <span class="content-name"> Course Adviser's Full Name</span>
    </label>
  </div><br><br>

   <!-- <input type="text" name="code" class="form-control" placeholder="Course Code (No Spacing)"><br>

   <input type="text" name="tit" class="form-control" placeholder="Course Title" required=""> -->
  ...
  <span class="content-name"> Authentication Code</span>
  </label>
  </div><br>
  
   <button name="sub" class="btn btn-info btn-block "><b><i class="fa fa-gears"></i> Create</b></button>
</form>
 </div>
 </div>
</div>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" style="color:#3399CC;">Course Adviser Login</h4>
        </div>
