...
<div class="sidebar">
  ...
  <a class="active" href="submit.php"><span class="glyphicon glyphicon-share"></span> Complain / Question <span class="badge">
    <?php
...
<section class="s_log">
  ...
  <a href="submit.php"  class="smoblink"><li id="act"><span class="glyphicon glyphicon-share"></span> Complain / Question 
  <span class="badge">
    <?php
  $mysqli1="select * from submit_ted where student_id='$id' ";
  $myquery1=mysqli_query($con,$mysqli1) or die(mysqli_error($con));
